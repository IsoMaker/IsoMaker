...
namespace UI {
    ...
    const Color PRIMARY = {30, 27, 46, 255};        // #1E1B2E
    const Color SECONDARY = {40, 36, 60, 255};      // #28243C
    const Color BACKGROUND = {248, 244, 255, 255};  // #F8F4FF
    const Color TEXT_PRIMARY = {253, 251, 255, 255};// #FDFBFF
    const Color TEXT_SECONDARY = {176, 174, 184, 255}; // #B0AEB8
